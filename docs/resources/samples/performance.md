...
description: 'Learn how to optimize read and write performance in Office Scripts.'
ms.date: 03/03/2021
...
See the [getting started performance section](getting-started.md#basic-performance-considerations) for the basics of Office Scripts.
