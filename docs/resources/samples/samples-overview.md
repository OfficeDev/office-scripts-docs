...
| [Report day-to-day changes in Power Automate](report-day-to-day-changes.md) | This sample uses a scheduled Power Automate flow to record daily readings and report the changes. |
