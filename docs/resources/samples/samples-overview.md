...
| [Recurring tasks with Excel Automation and Power Apps](https://www.kalmstrom.com/Tips/Excel-Automation/) | This script was contributed by [Peter Kalmström](https://www.linkedin.com/in/kalmstrom/). It illustrates a way to create, store in Excel and edit the current ones in Power Apps. Includes uploading images, reporting time spent and automatically closing overdue tickets. |
