...
* [Version 1: Read and add a row to a worksheet containing plain range](#sample-code-generate-key-and-add-row-to-range)
    ...
    :::image type="content" source="../../images/document-number-generator-range-before.png" alt-text="Screenshot showing range before row is added":::

    _After the new row is added_

    :::image type="content" source="../../images/document-number-generator-range-after.png" alt-text="Screenshot showing range after row is added":::

* [Version 2: Read and add a row to a table](#sample-code-generate-key-and-add-row-to-table)

    _Before the new row is added_

    :::image type="content" source="../../images/document-number-generator-table-before.png" alt-text="Screenshot showing table before row is added":::

    _After the new row is added_

    :::image type="content" source="../../images/document-number-generator-table-after.png" alt-text="Screenshot showing table after row is added":::
