...
Add the following script to the sample workbook. In Excel, **Automate** > **New Script** to paste the code and save the script. Save it as **Convert CSV** and try the sample yourself!
